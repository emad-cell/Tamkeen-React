      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1" style={{ direction: "ltr" }}>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
                Join our platform today and be part of a supportive community
              </h2>
              <p className="text-gray-600 text-lg mb-8">
                Whether you are an individual looking for specialized support or
                an association ready to provide services, our platform opens new
                opportunities for connection, care, and impact.
              </p>
              ...
              <div className="flex flex-col md:flex-row gap-4 mb-10">
                ...
                >
                  <Building size={20} />
                  <span>Register as Association</span>
                  <ArrowRight size={16} />
                </Link>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm p-4 rounded-lg shadow-sm">
                <p className="text-gray-700 text-sm">
                  "We follow high privacy and security standards to provide a
                  safe, seamless experience for everyone, with accessibility and
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm font-medium">
                      Join more than 5,000 users and 150 specialized
                      associations
                    </p>
                  </div>
                </div>
