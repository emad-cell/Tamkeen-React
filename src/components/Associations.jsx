...
const associationsData = [
  {
    id: 1,
    name: "Special Needs Care Association",
    location: "Riyadh",
    rating: 4.8,
    specialties: ["Medical Rehabilitation", "Special Education"],
    image: "zoro-looking-fierce-and-ready-to-fight-desktop-wallpaper-cover.jpg",
  },
  {
    id: 2,
    name: "Al Noor Physical Therapy Center",
    location: "Jeddah",
    rating: 4.6,
    specialties: ["Physical Therapy", "Motor Rehabilitation"],
    image: "zoro-looking-fierce-and-ready-to-fight-desktop-wallpaper-cover.jpg",
  },
  {
    id: 3,
    name: "Al Amal Mental Health Foundation",
    location: "Dammam",
    rating: 4.9,
    specialties: ["Psychological Counseling", "Behavioral Therapy"],
    image: "zoro-looking-fierce-and-ready-to-fight-desktop-wallpaper-cover.jpg",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-block bg-white text-primary font-semibold px-4 py-2 rounded-full mb-4">
            Our Specialized Associations
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
            Discover trusted associations focused on inclusive care
          </h2>
          <p className="text-gray-600 text-lg">
            We partner with licensed, specialized organizations to deliver
            high-quality services for platform users.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-10">
          <div className="bg-white rounded-xl shadow-md p-4 flex flex-col md:flex-row gap-4">
            <div className="flex-grow relative">
              ...
              <input
                type="text"
                placeholder="Search for an association or service..."
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <select className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/30">
                    ...
                    <option value="Psychological Counseling">
