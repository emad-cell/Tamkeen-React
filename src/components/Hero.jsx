    ...
    <div className="relative overflow-hidden pt-32 pb-20 md:pt-40 md:pb-24 bg-gradient-to-br from-secondary to-blue-50">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div
            className="order-1 lg:order-1 animate-fade-in"
            style={{ direction: "ltr" }}
          >
            <div className="inline-block bg-accent/10 text-accent font-semibold px-4 py-2 rounded-full mb-6">
              A platform connecting people with disabilities to specialized
              services
            </div>
            ...
            <p className="text-lg text-gray-600 mb-6 max-w-xl">
              A complete digital experience designed to help people with
              disabilities and their families reach essential services by
              connecting them with trusted associations through a secure and
              structured platform.
            </p>
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                <img
                  ...
                  alt="Inclusive support services"
